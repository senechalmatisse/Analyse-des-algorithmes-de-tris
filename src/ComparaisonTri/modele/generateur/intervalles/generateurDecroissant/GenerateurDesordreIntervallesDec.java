package ComparaisonTri.modele.generateur.intervalles.generateurDecroissant;
 ...
 */
public class GenerateurDesordreIntervallesDec extends GenerateurDesordreIntervalles {
     ...
     */
    public GenerateurDesordreIntervallesDec(int tailleTab, int desordre, String repartition) {
        super(tailleTab, desordre, repartition);
    }

    @Override
    public String getNomGen() {
        return "DesordreIntervallesDec";
    }
}